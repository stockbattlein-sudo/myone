...
// Scroll Reveal Hook
const useScrollReveal = (activePage: string) => {
  useEffect(() => {
...
const Navbar = ({ activePage, setActivePage, handleNavClick }: { activePage: string; setActivePage: (page: string) => void; handleNavClick: (e: React.MouseEvent, sectionId: string) => void }) => {
  const [menuOpen, setMenuOpen] = useState(false);

  const toggleMenu = () => setMenuOpen(prev => !prev);
  const closeMenu = () => setMenuOpen(false);

  const handleNavClickLocal = (e: React.MouseEvent, sectionId: string) => {
    closeMenu();
  ...
  return (
    <>
      <nav className="navbar" id="navbar">
        <div className="nav-inner">
          ...
          <ul className="nav-links">
            <li><a href="#how-it-works" onClick={(e) => handleNavClickLocal(e, 'how-it-works')}>How it Works</a></li>
            <li><a href="#pricing" onClick={(e) => handleNavClickLocal(e, 'pricing')}>Assessments</a></li>
            <li><a href="#competition" onClick={(e) => handleNavClickLocal(e, 'competition')}>Competition</a></li>
          </ul>
      ...
      <div className={`mobile-menu ${menuOpen ? 'open' : ''}`} id="mobileMenu">
        <a href="#how-it-works" onClick={(e) => handleNavClickLocal(e, 'how-it-works')}>How it Works</a>
        <a href="#pricing" onClick={(e) => handleNavClickLocal(e, 'pricing')}>Assessments</a>
        <a href="#competition" onClick={(e) => handleNavClickLocal(e, 'competition')}>Competition</a>
...
const HomeContent = ({ setActivePage, handleNavClick }: { setActivePage: (page: string) => void; handleNavClick: (e: React.MouseEvent, sectionId: string) => void }) => {
        ...
        <div className="hero-container">
          <div className="hero-inner fade-up visible">
            ...
            <div className="asset-tags">
              ...
              <span className="asset-tag">📈 Equities</span>
            ...
            <table className="assessment-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <svg className="check-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                  </td>
                  <td className="highlight-col">
...
const WaitlistContent = ({ setActivePage }: { setActivePage: (page: string) => void }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        if (error.code === '23505') {
          alert('You are already registered on the waitlist with this email address!');
        } else {
...
export default function LandingPages() {
  ...
  return (
    <>
      <Navbar activePage={activePage} setActivePage={setActivePage} handleNavClick={handleNavClick} />
      {activePage === 'home' ? (
        <HomeContent setActivePage={setActivePage} handleNavClick={handleNavClick} />
      ) : (
